    ...
    public void run(String... args) throws Exception {
        ...
        while (true) {
            ...
            if (command.equals("quit")) {
                ...
                System.out.println("\"addClub\" - to add new club");
            ...
            else if (command.equals("addClub")) {
                String club_name;
                int year_of_foundation;
                double market_value;
                System.out.println("WRITE CLUBS NAME:");
                club_name = sc.nextLine();
                System.out.println("WRITE YEAR OF FOUNDATION:");
                year_of_foundation = sc.nextInt();
                System.out.println("WRITE TEAMS MARKET VALUE:");
                market_value = sc.nextDouble();
                sc.nextLine();

                Club addedClub = Club.builder()
                        .name(club_name)
                        .year_of_foundation(year_of_foundation)
                        .teams_market_value(market_value)
                        .build();

                clubService.saveNew(addedClub);
